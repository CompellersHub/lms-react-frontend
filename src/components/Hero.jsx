...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[500px] h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 flex h-full flex-col items-start justify-center px-6 md:px-12 lg:px-16 py-16 space-y-8">
        {" "}
        ...
        <h1 className="mt-6 text-2xl font-bold text-white drop-shadow-lg md:text-3xl lg:text-6xl">
          At Titans Careers, growth and learning drive us.
          Explore opportunities to develop your skills and shape the future with us
        </h1>
        <p className="mt-4 max-w-2xl text-2xl text-blue-100 drop-shadow-md">
