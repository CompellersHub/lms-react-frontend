...
export function WorkshopEvents() {
  ...
  />
  <div className="relative z-10 w-full px-6 md:px-12 lg:px-16 py-20 text-center flex flex-col items-center justify-center bg-black/40">
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl md:text-5xl font-bold text-amber-50 mb-6 drop-shadow-lg">
